...
ggplot(wine_df, aes(x=pH, y=fixed.acidity))+
  ...
  labs(title='Scatterplot of Fixed-acidity vs pH of red wine')
```
...
ggplot(wine_df, aes(x=pH, y=density))+
  ...
  labs(title='Scatterplot of density vs pH of red wine')
```
...
ggplot(wine_df,aes(y=density,x=alcohol))+
  ...
  labs(x='Alcohol content', title='Scatterplot of density vs alcohol content in red wine')
```
