...
Analyzing the above plot it can be seen that as the quality of red wine improves
...
it is observed that pH value of wine lies between 3 and 4 . Also for a good 
quality of red wine pH value must be less than 3.5. As it is observed from the 
above graph majority of the red wines have pH below 3.5 and as pH decreases 
...
wine improves gradually. So referring to the graph, good quality wines tend to 
move towards the bottom right corner of the graph.
...
by quality. It can be seen that as the alcohol content  decreases the density of
