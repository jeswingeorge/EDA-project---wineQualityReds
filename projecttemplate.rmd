...
acidity mostly ranges between 6.5 g/dm^3^ and 8 g/dm^3^ respectively. And the 
best two  available qualities of wine __Quality 7 and 8__ have a very low count 
and their  value of fixed acidity usually varies between 6.5 and 11.5 g/dm^3^. 
...
The __Quality 8__ of red wine has median fixed acidity  of 8.25 g/dm^3^ and 
mean fixed acidity of 8.567 g/dm^3^. The __Quality 7__ of red wine has median 
fixed acidity of 8.8 g/dm^3^ and mean fixed acidity of 8.872 g/dm^3^.  
...
the amount of citric acid in them range from 0 t0 0.6 g/dm^3^  and their values
...
acid of 0.42 g/dm^3^ and .4 g/dm^3^ and mean volatile acidity of 0.3911 g/dm^3^
...
So i created a new variable called __Total_acidity__ (measured in g/dm^3^) 
...
The above faceted distribution shows distribution of proportion of free SO^2^ 
...
proportion of free SO^2^ with respect to total sulfur dioxide. The red point 
...
Did you perform any operation on the data to tidy, adjust, or change the form \
...
available.
3. Amount of residual sugar levels (in g/dm^3^) in red wines have no affect on
quality of red wine,
